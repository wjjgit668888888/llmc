...
class SparseVLM(TokenReductionModule):
    ...
    def add_sparse_config(self):
        ...
        # 新增配置参数
        self.init_token_total_shape = special_config.get('init_token_total_shape', 668)
        self.generate_process_count = special_config.get('generate_process_count', 0)
        self.pre_prompt_length_list = special_config.get('pre_prompt_length_list', [])
        self.image_shape = special_config.get('image_shape', 576)
    ...
    def decoder_attn_logits_hook(module, inputs, output):
        ...
        attn_logits = getattr(module, "cached_attn_logits")
